...
**FTRE ACCEPTANCE TEST (RD's, binding):** FTRE fired 07-20 during the operator's vacation → the panel shows **viewed=NO** across the armed window → it classifies **AWAY**, is **EXCLUDED** from the discipline signal, and its **+1.22R** lands in the away bucket rather than being scored against his judgment. *The scheme must reproduce this.*
