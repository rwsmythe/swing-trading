...
- [ ] **4a — Immediate remediation (cause confirmed):** record the missing late-May recurring $100 deposit via `swing journal cash --deposit 100 --date <≈5/29–5/30>` → the ACCOUNT tile reconciles to ~$2027. (Operator-doable now; the residual $0.44 is noise.)
