...
**Status:** DRAFT roadmap for operator approval; nothing commissioned until Phase 17 closes (17-D.4 + the .2 icon recheck) and the operator sequences. Architecture passes for the tripwire-crossing arcs are pre-done or owed by CHARC at commissioning.
