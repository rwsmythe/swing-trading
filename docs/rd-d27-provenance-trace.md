...
**Source of the hits:** the 21-G `data_asof_date` consumer survey (`docs/data-asof-date-consumer-survey-21g.md` — on main since the 21-G merge `6b1a7860`; retained top-level as the arc's stable evidence artifact).
